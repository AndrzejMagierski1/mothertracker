...
void Sequencer::loadDefaultSequence(void)
{
	...
	seq[player.ramBank].track[0].step[0].instrument = 4;
	seq[player.ramBank].track[0].step[0].note = 24;
	seq[player.ramBank].track[0].step[0].length1 = 100;
/*
	seq[player.ramBank].track[1].step[3].isOn = 1;
	seq[player.ramBank].track[1].step[3].instrument = 3;
	seq[player.ramBank].track[1].step[3].note = 24;
	seq[player.ramBank].track[1].step[3].length1 = 100;

	seq[player.ramBank].track[1].step[6].isOn = 1;
	seq[player.ramBank].track[1].step[6].instrument = 3;
	seq[player.ramBank].track[1].step[6].note = 27;
	seq[player.ramBank].track[1].step[6].length1 = 100;
*/
	seq[player.ramBank].track[2].step[0].isOn = 1;
	seq[player.ramBank].track[2].step[0].instrument = 6;
	seq[player.ramBank].track[2].step[0].note = 24;
	seq[player.ramBank].track[2].step[0].length1 = 100;

	seq[player.ramBank].track[3].step[7].isOn = 1;
	seq[player.ramBank].track[3].step[7].instrument = 2;
	seq[player.ramBank].track[3].step[7].note = 24;
	seq[player.ramBank].track[3].step[7].length1 = 50;


	seq[player.ramBank].track[3].step[8].isOn = 1;
	seq[player.ramBank].track[3].step[8].instrument = 0;
	seq[player.ramBank].track[3].step[8].note = 20;
	seq[player.ramBank].track[3].step[8].length1 = 300;
