...
#define USE_SERIAL_PORT         Serial5      // Change the number (to Serial1 for example) if you want
...
#define USE_SERIAL_PORT         Serial5
#endif
...
public:
	...
	void begin(const byte inChannel);
	void begin(const byte inChannel,  const byte set_serial_no);
