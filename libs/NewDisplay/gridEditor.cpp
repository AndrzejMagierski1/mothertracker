...
//--------------------------------------------------------------------------------
//--------------------------------------------------------------------------------
cGridEditorPopup::cGridEditorPopup(strControlProperties* properties): cDisplayControl(controlIdNotePopup)
{
	colorsCount = 3;
	...
	padNames = (strPadNamesGridEditor*)properties->data;

	setStyle(properties->style);
	fillpadMap();
}

cGridEditorPopup::~cGridEditorPopup()
{
...
//--------------------------------------------------------------------------------
//--------------------------------------------------------------------------------
void cGridEditorPopup::setStyle(uint32_t style)
{
	this->style = style;
...
void cGridEditorPopup::setText(const char* text)
{
	this->text = text;
}

void cGridEditorPopup::setValue(int value)
{
	this->value = value;
}

void cGridEditorPopup::setColors(uint32_t* colors)
{
	this->colors = colors;
}

void cGridEditorPopup::setDefaultColors(uint32_t colors[])
{
	memcpy(defaultColors, colors, colorsCount*4);
}

void cGridEditorPopup::setData(void* data)
{
	padNames = (strPadNamesGridEditor*)data;
}

//--------------------------------------------------------------------------------
//--------------------------------------------------------------------------------
//--------------------------------------------------------------------------------
uint8_t cGridEditorPopup::update()
{
...
//		localString[4]=0; // 5 chararacter is max
		...
		API_CMD_TEXT(padMap[i].x + padMap[i].w/2, padMap[i].y + padMap[i].h/4, textFont, OPT_CENTER, padNames->noteName[i]);
		API_CMD_TEXT(padMap[i].x + padMap[i].w/2, padMap[i].y + 3 * padMap[i].h/4, textFont, OPT_CENTER, padNames->finetuneName[i]);
	}
...
uint8_t cGridEditorPopup::memCpy(uint32_t address)
{
...
uint8_t cGridEditorPopup::append(uint32_t address)
{
...
void cGridEditorPopup::fillpadMap()
{
