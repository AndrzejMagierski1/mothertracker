...
void cSampleEditor::changeZoom(int16_t value)
{
	...
	if(zoom.zoomValue + fVal < ZOOM_MIN) zoom.zoomValue  = ZOOM_MIN;
	else if(zoom.zoomValue + fVal > ZOOM_MAX ) zoom.zoomValue  = ZOOM_MAX;
	else zoom.zoomValue += fVal;
