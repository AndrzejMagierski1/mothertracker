...
//==================================================================================================================
void cFunctionMachine::setButtonObj(uint8_t objectID, uint8_t state, uint8_t(*funct)(void), hControl control)
{
...
void cFunctionMachine::setButtonObj(uint8_t objectID, uint8_t(*funct)(uint8_t), hControl control)
{
...
{
	if(!buttons[button].mode) return;

	uint8_t result = 0;

	if(buttons[button].funct1 != nullptr && state == buttons[button].state) result = buttons[button].funct1();
	else if(buttons[button].funct2 != nullptr) result = buttons[button].funct2(state);
